...
- Displays bookmarks in hierarchical tree view with collapsible folders
- Shows bookmark titles with favicons
- Persists folder collapse/expand state across sessions
...
- Search results displayed in flat grouped view
...
- Light theme with clean white background and warm grays
- Dark theme with refined dark background
